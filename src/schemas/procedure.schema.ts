...
export const listProceduresSchema = z.object({
  ...
  orderBy: z.enum(['nome', 'preco', 'duracao', 'categoria', 'createdAt']).optional().default('nome'),
...
export type GetProceduresByCategoryParams = z.infer<typeof getProceduresByCategorySchema>;
