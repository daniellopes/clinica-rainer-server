...
export const listProductsSchema = z.object({
  ...
  estoqueMinimo: z.string().optional().transform(val => val === 'true'),
  orderBy: z.enum(['nome', 'categoria', 'estoqueAtual', 'precoCusto', 'precoVenda', 'createdAt']).optional().default('nome'),
...
export type GetProductByBarcodeParams = z.infer<typeof getProductByBarcodeSchema>;
