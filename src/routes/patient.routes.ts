...
router.post('/:id/upload-document', upload.single('file'), PatientController.uploadDocument);
...
router.get('/documents/:documentId/download', PatientController.downloadDocument);
...
router.get('/:id', validateParamsZod(getPatientByIdSchema), PatientController.getById);
router.put('/:id', validateParamsZod(getPatientByIdSchema), PatientController.update); // Removido validateZod - validação será feita no controller
router.delete('/:id', validateParamsZod(getPatientByIdSchema), PatientController.delete);
